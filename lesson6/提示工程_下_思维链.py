...
cot_template = '''
为一个为花店电商公司工作的AI助手，我的目标是帮助客户根据他们的喜好做出明智的决定。 
...
示例 2:
  ...
  它们在世界上的许多地方都被视为奢侈品和美的象征。因此，我建议你考虑兰花。选择兰花可以满足你对独特和奇特的要求，
  而且，兰花的美丽和它们所代表的力量和奢侈也可能会吸引你。
'''

tot_template = '''假设一个顾客在鲜花网站上询问：“我想为我的妻子购买一束鲜花，但我不确定应该选择哪种鲜花。她喜欢淡雅的颜色和花香。”  
...
tot_prompt = SystemMessagePromptTemplate.from_template(tot_template)
role_prompt = SystemMessagePromptTemplate.from_template(role_template)
cot_prompt = SystemMessagePromptTemplate.from_template(cot_template)

human_template = "{human_input}"
human_prompt = HumanMessagePromptTemplate.from_template(human_template)

chat_prompt = ChatPromptTemplate.from_messages([role_prompt,tot_prompt,human_prompt])
...
msg = chat_prompt.format(human_input="我想为我的女朋友购买一些花。她喜欢粉色和紫色。你有什么建议吗?")
